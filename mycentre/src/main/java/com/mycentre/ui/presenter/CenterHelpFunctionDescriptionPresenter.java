...
public class CenterHelpFunctionDescriptionPresenter {

    private BaseActivity activity;
    private LifecycleProvider lifecycleProvider;
    private CenterHelpFunctionDescriptionView mView;
    ...
    public CenterHelpFunctionDescriptionPresenter(BaseActivity activity, LifecycleProvider lifecycleProvider, CenterHelpFunctionDescriptionView mView) {
        this.mView = mView;
