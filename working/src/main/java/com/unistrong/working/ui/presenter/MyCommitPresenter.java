...
public class MyCommitPresenter {
    private MyCommitView mView;
    private BaseActivity activity;
    private LifecycleProvider lifecycleProvider;

    public MyCommitPresenter(MyCommitView mView, BaseActivity activity, LifecycleProvider lifecycleProvider) {
        this.mView = mView;
    ...
    public void getHttpRequestData(long id){
        ...
        httpManager.doHttpDeal(RetrofitHelper.getApiService().getRequestCommitDetails(id),
