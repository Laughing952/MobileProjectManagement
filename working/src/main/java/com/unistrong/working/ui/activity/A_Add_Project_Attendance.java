...
import com.unistrong.working.databinding.AAddProjectAttendanceBinding;
...
import com.unistrong.working.ui.presenter.AddProjectAttendancePresenter;
...
/**
 * 新建——项目考勤点（从已有项目中选中一个考勤点，并以其为打卡中心）
 * 作者：Laughing on 2018/5/3 20:37
 * 邮箱：719240226@qq.com
 */

public class A_Add_Project_Attendance extends TitleActivity implements AddProjectAttendanceView {

    private AddProjectAttendancePresenter mPresenter;
    private AAddProjectAttendanceBinding mBinding;
    ...
    private String mTvAddCustomAttendanceAddress;
    private String mProjectId;//项目Id

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = setView(R.layout.a_add_project_attendance);
        initTitle();
        initView();
        initData();
        initListener();
    ...
    private void initData() {
        mPresenter = new AddProjectAttendancePresenter(this, this, this);
        mBinding.setClick(v -> mPresenter.click(v));
        mPresenter.getProjectList(UserIdUtil.getUserIdLong());
    }
    ...
    public static void startActivity(Context context) {
        context.startActivity(new Intent(context, A_Add_Project_Attendance.class));
    }
    ...
    private void judgmentAttendanceNameIsEmpty() {
        //考勤点名称
        mEtName = mBinding.tvAddProjectAttendanceChooseProject.getText().toString().trim();
        //考勤点名称
        mTvAddCustomAttendanceAddress = mBinding.tvAddProjectAttendanceAddress.getText().toString().trim();
    ...
    private void collectionData() {
        ...
        String tvAddCustomAttendanceRange = mBinding.tvAddProjectAttendanceRange.toString().trim();//考勤范围
...
//        String i = (mBinding.cbPunchSetting1.isChecked() ? 1 : 0) + "";//星期是否选中
        list2.add(new SigninTime("", "0", mBinding.tvAddProjectAttendanceTime1.getText().toString(),
                mBinding.tvAddProjectAttendanceTime12.getText().toString(),
                (mBinding.cbPunchSetting1.isChecked() ? 0 : 1) + ""));
        list2.add(new SigninTime("", "1", mBinding.tvAddProjectAttendanceTime2.getText().toString(),
                mBinding.tvAddProjectAttendanceTime22.getText().toString(),
                (mBinding.cbPunchSetting2.isChecked() ? 0 : 1) + ""));
        list2.add(new SigninTime("", "2", mBinding.tvAddProjectAttendanceTime3.getText().toString(),
                mBinding.tvAddProjectAttendanceTime32.getText().toString(),
                (mBinding.cbPunchSetting3.isChecked() ? 0 : 1) + ""));
        list2.add(new SigninTime("", "3", mBinding.tvAddProjectAttendanceTime4.getText().toString(),
                mBinding.tvAddProjectAttendanceTime42.getText().toString(),
                (mBinding.cbPunchSetting4.isChecked() ? 0 : 1) + ""));
        list2.add(new SigninTime("", "4", mBinding.tvAddProjectAttendanceTime5.getText().toString(),
                mBinding.tvAddProjectAttendanceTime52.getText().toString(),
                (mBinding.cbPunchSetting5.isChecked() ? 0 : 1) + ""));
        list2.add(new SigninTime("", "5", mBinding.tvAddProjectAttendanceTime6.getText().toString(),
                mBinding.tvAddProjectAttendanceTime62.getText().toString(),
                (mBinding.cbPunchSetting6.isChecked() ? 0 : 1) + ""));
        list2.add(new SigninTime("", "6", mBinding.tvAddProjectAttendanceTime7.getText().toString(),
                mBinding.tvAddProjectAttendanceTime72.getText().toString(),
                (mBinding.cbPunchSetting7.isChecked() ? 0 : 1) + ""));

        AddCustomAttendanceReq addCustomAttendanceReq = new AddCustomAttendanceReq("", mProjectId,
    ...
    @Override
    public void setPerformerResult(CreateNewTask_ProjectNameRep rep) {
        mBinding.tvAddProjectAttendanceChooseProject.setText(rep.getItemname());
        mProjectId = rep.getItemid();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0x456 && resultCode == 0x457) {
            if (data != null) {
                ...
                mBinding.tvAddProjectAttendanceAddress.setText(mAddress);       //考勤点名称
...
//                LogUtil.e("TAG", "laughing--------------mAddress-------->   " + mAddress);
    ...
    private void setDate2TextView(int week, int i, String dateStr) {
        ...
        switch (week) {
            case 1:
                viewSetData(i, dateStr, mBinding.cbPunchSetting1, mBinding.tvAddProjectAttendanceTime1, mBinding.tvAddProjectAttendanceTime12);

                break;
            case 2:
                viewSetData(i, dateStr, mBinding.cbPunchSetting2, mBinding.tvAddProjectAttendanceTime1, mBinding.tvAddProjectAttendanceTime22);

                break;
            case 3:
                viewSetData(i, dateStr, mBinding.cbPunchSetting3, mBinding.tvAddProjectAttendanceTime3, mBinding.tvAddProjectAttendanceTime32);

                break;
            case 4:
                viewSetData(i, dateStr, mBinding.cbPunchSetting4, mBinding.tvAddProjectAttendanceTime4, mBinding.tvAddProjectAttendanceTime42);

                break;
            case 5:
                viewSetData(i, dateStr, mBinding.cbPunchSetting5, mBinding.tvAddProjectAttendanceTime5, mBinding.tvAddProjectAttendanceTime52);

                break;
            case 6:
                viewSetData(i, dateStr, mBinding.cbPunchSetting6, mBinding.tvAddProjectAttendanceTime6, mBinding.tvAddProjectAttendanceTime62);

                break;
            case 7:
                viewSetData(i, dateStr, mBinding.cbPunchSetting7, mBinding.tvAddProjectAttendanceTime7, mBinding.tvAddProjectAttendanceTime72);
    ...
    public void showDialog2() {
        ...
        tv_task_participant.setOnClickListener(v -> {
            // 300米
            mBinding.tvAddProjectAttendanceRange.setText("300米");
            dialog.dismiss();
        });
        tv_urge_task.setOnClickListener(v -> {
            //500米
            mBinding.tvAddProjectAttendanceRange.setText("500米");
            dialog.dismiss();

        });
        tv_edit_task.setOnClickListener(v -> {
            // 1000米
            mBinding.tvAddProjectAttendanceRange.setText("1000米");
            dialog.dismiss();
        ...
        tv_cancel_task.setOnClickListener(v -> {
            dialog.dismiss();
            // 2000米
            mBinding.tvAddProjectAttendanceRange.setText("2000米");
