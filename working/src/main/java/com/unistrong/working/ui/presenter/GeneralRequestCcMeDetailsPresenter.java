...
public class GeneralRequestCcMeDetailsPresenter {
    private GeneralRequestCcMeDetailsView mView;
    private BaseActivity activity;
    private LifecycleProvider lifecycleProvider;

    public GeneralRequestCcMeDetailsPresenter(GeneralRequestCcMeDetailsView mView, BaseActivity activity, LifecycleProvider lifecycleProvider) {
        this.mView = mView;
    ...
    public void click(View view) {
        if (view.getId() == R.id.rl_general_request_cc_me_content) {
            //点击查看-内容
            mView.jump();
        }
    }
