...
public class GeneralApprovalIApprovedVM {
    ...
    private GeneralApprovalIApprovedBean mMyApprovalBean;//

    public GeneralApprovalIApprovedVM(GeneralApprovalIApprovedBean mMyApprovalBean) {
