...
public class CcMePresenter {
    private CcMeView mView;
    private BaseActivity activity;
    private LifecycleProvider lifecycleProvider;

    public CcMePresenter(CcMeView mView, BaseActivity activity, LifecycleProvider lifecycleProvider) {
        this.mView = mView;
    ...
    public void getHttpRequestData(long id){
        ...
        httpManager.doHttpDeal(RetrofitHelper.getApiService().getRequestCcMeDetails(id),
