...
public class GeneralRequest_ICommitDetailsVM {
    ...
    private GeneralRequest_ICommitDetailsBean mGeneralRequest_iCommitDetailsBean;

    public GeneralRequest_ICommitDetailsVM(GeneralRequest_ICommitDetailsBean generalRequest_iCommitDetailsBean) {
        this.mGeneralRequest_iCommitDetailsBean = generalRequest_iCommitDetailsBean;
    }
