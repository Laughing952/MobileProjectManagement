...
public class GeneralApprovalItemVM {
    ...
    public GeneralApprovalItemVM(GeneralRequestItemDetailRep itemDetailRep) {
    ...
    public int getTitleColor() {
        String status = itemDetailRep.getApproveStatus();//审批状态 0:待审批1:驳回2审批通过
        if ("0".equals(status)){
