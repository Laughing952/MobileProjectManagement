...
public class GeneralRequest_CcMeDetailsVM {
    ...
    private GeneralRequest_CcMeDetailsBean mGeneralRequest_ccMeDetailsBean;

    public GeneralRequest_CcMeDetailsVM(GeneralRequest_CcMeDetailsBean generalRequest_ccMeDetailsBean) {
        this.mGeneralRequest_ccMeDetailsBean = generalRequest_ccMeDetailsBean;
    }
