...
public class MyApprovalVM {
    ...
    public MyApprovalVM(MyApprovalBean mMyApprovalBean) {
        this.mMyApprovalBean = mMyApprovalBean;
    }
    ...
    public MyApprovalBean getMyApprovalBean() {
        return mMyApprovalBean;
    }

    public void setMyApprovalBean(MyApprovalBean myApprovalBean) {
        mMyApprovalBean = myApprovalBean;
    }
}
