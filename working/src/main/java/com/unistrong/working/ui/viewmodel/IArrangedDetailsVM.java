...
public class IArrangedDetailsVM {
    ...
    private IArrangedDetailsBean mIArrangedDetailsBean;//

    public IArrangedDetailsVM(IArrangedDetailsBean mIArrangedDetailsBean) {
        this.mIArrangedDetailsBean = mIArrangedDetailsBean;
    }
