...
public class WorkingTaskPresenter {
    private WorkingTaskView mView;
    private BaseActivity activity;
    private LifecycleProvider lifecycleProvider;

    public WorkingTaskPresenter(WorkingTaskView mView, BaseActivity activity, LifecycleProvider lifecycleProvider) {
        this.mView = mView;
